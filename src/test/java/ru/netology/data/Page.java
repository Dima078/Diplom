...
public class Page {
    public static SelenideElement buttonDebit = $(withText("Купить"));
    public static SelenideElement buttonCredit = $(withText("Купить в кредит"));
    public static SelenideElement fieldCardNumber = $("[placeholder='0000 0000 0000 0000']");
    public static SelenideElement invalidCardNumber = $x("//*[@id=\"root\"]/div/form/fieldset/div[1]/span/span/span[3]");
    public static SelenideElement fieldMonth = $("[placeholder='08']");
    public static SelenideElement invalidMonth = $x("//*[@id=\"root\"]/div/form/fieldset/div[2]/span/span[1]/span/span/span[3]");
    public static SelenideElement fieldYear = $("[placeholder='22']");
    public static SelenideElement invalidYear = $x("//*[@id=\"root\"]/div/form/fieldset/div[2]/span/span[2]/span/span/span[3]");
    public static SelenideElement fieldCardHolder = $x("//*[@id=\"root\"]/div/form/fieldset/div[3]/span/span[1]/span/span/span[2]/input");
    public static SelenideElement invalidCardHolder = $x("//*[@id=\"root\"]/div/form/fieldset/div[3]/span/span[1]/span/span/span[3]");
    public static SelenideElement fieldCvC = $("[placeholder='999']");
    public static SelenideElement invalidCvC = $x("//*[@id=\"root\"]/div/form/fieldset/div[3]/span/span[2]/span/span/span[3]");
    ...
    public static SelenideElement closeNotificationContentError = $x("//*[@id=\"root\"]/div/div[3]/button/span/span/span");
}
