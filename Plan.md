...
**1. Покупка тура тестовой дебетовой картой №1**

1. Открыть в браузере страницу по адресу http://localhost:8080/
2. Нажать кнопку "Купить"
3. Заполнить поле "Номер карты" валидным значением тестовой карты № 1 (4444 4444 4444 4441)
...
**2. Покупка тура тестовой кредитной картой №1**
...
**3. Покупка тура тестовой дебетовой картой №2**

1. Открыть в браузере страницу по адресу http://localhost:8080/
2. Нажать кнопку "Купить"
3. Заполнить поле "Номер карты" валидным значением тестовой карты № 2 (4444 4444 4444 4442)
4. Заполнить поле "Месяц" валидным значением (например 09)
5. Заполнить поле "Год" валидным значением (например 23)
6. Заполнить поле "Владелец" валидным значением (например DIMA DIMOV)
7. Заполнить поле "CVC/CVV" валидным значением (например 123)
...
**4. Покупка тура тестовой кредитной картой №2**
...
**5. Покупка тура нетестовой дебетовой картой**

1. Открыть в браузере страницу по адресу http://localhost:8080/
2. Нажать кнопку "Купить"
3. Заполнить поле "Номер карты" валидным значением тестовой карты № 1 (4444 4444 4444 4445)
4. Заполнить поле "Месяц" валидным значением (например 09)
5. Заполнить поле "Год" валидным значением (например 23)
6. Заполнить поле "Владелец" валидным значением (например DIMA DIMOV)
7. Заполнить поле "CVC/CVV" валидным значением (например 123)
...
**6. Покупка тура нетестовой кредитной картой**
